...
/*   Updated: 2022/12/01 16:25:16 by johrober         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	set_hit_params(t_hit *hit, t_ray *ray, t_cylinder *cyl, double *t)
{
	t_vec	oc;
	t_vec	op;
	double	ht;
	...
	if (ht == t[2] || ht == t[3])
	{
		...
		if ((ht == t[3]) != (dot_product(ray->dir, cyl->dir) > 0.0))
